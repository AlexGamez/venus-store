...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Atkinson+Hyperlegible+Next:wght@400;700&family=Bebas+Neue&family=DM+Serif+Text&family=Jost:wght@300;600&family=League+Spartan:wght@400;700&family=Libre+Franklin:wght@300;600&family=Merienda&family=Oswald:wght@400;700&family=Roboto:wght@400;700&family=Markazi+Text:wght@400..700&display=swap"
        rel="stylesheet">
    <link
        href="https://fonts.googleapis.com/css2?family=Zalando+Sans+Expanded:ital,wght@0,200..900;1,200..900&family=Zalando+Sans+SemiExpanded:ital,wght@0,200..900;1,200..900&display=swap"
        rel="stylesheet">


    <!-- Iconos de google -->
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=shelves" />
                    ...
                    <div class="modal-body">
                        <form id="formEditarProducto" method="POST" action="procesar_edicion.php">
                            ...
                            <div class="form-1">
                                ...
                                <label>Precio:</label>
                                <input type="number" name="precio" id="editar_precio" step="0.01" class="form-control"
                                    required>
                                ...
                                <label>Color:</label>
                                <input type="text" name="color" id="editar_color" class="form-control"
                                ...
                                <div id="contenedor-tallas-edit" class="mt-0">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary mt-2"
                                        onclick="agregarFilaTallaEdit()">+Agregar Talla
                                    </button>
                                </div>
                            </div>
