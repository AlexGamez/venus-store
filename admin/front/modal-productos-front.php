<!-- modal_producto.php -->
<div class="modal fade mt-4" id="productoModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="true"
  ...
  <div class="modal-dialog modal-xl modal-info">
    <div class="modal-padre">
      <div class="modal-content popup">
        ...
        <div class="popup-hijo">
          <div class="col-sm-6 col-md-5 col-lg-5 modal-body-producto foto-popup">
            <img id="modalImagen-producto" class="zoom-img" src=""
              alt=""><!-- Imagen Principal se inserta desde js tambien-->
          </div>
          ...
          <div class="col-sm-5 col-md-5 col-lg-5 sub-contenido">
            <div class="modal-header-producto">
              ...
              <p class="mt-4 ms-2" id="modalPrecioTexto">$<span
                  id="modalPrecio"><!-- Precio se inserta desde js --></span></p>
            </div>
            ...
            <div class="d-grid gap-2 mt-4 p-0 sumar-cesta">
              <button class="btn btn-lg w-90 checkout-modal">
        ...
        <div class="data-inferior">
          <div class="col-lg-12 descripcion">
            ...
            <span id="modalDescripcion">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo libero unde corporis consequuntur
              repudiandae provident vero recusandae, nam non modi quisquam repellendus commodi necessitatibus magni
              veritatis odit aliquid, dolore earum!
            </span>
          </div>
