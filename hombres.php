...
<div class="container text-center hero">
    <span class="msj-seccion">Sección Masculina</span>
</div> 
...
<section class="container-fluid d-flex justify-content-center mt-1 p-0">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <div class="flip-card mb-4" data-producto_id="<?= htmlspecialchars($row['producto_id']); ?>">
                <div class="flip-card-inner">
                    ...
                    <div>
                        <button class="agregar" id="verMas">Ver más</button>
                    </div>
