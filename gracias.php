...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Text&family=League+Spartan:wght@400;700&family=Libre+Franklin:wght@300;600&family=Merienda&family=Oswald:wght@400;700&family=Roboto:wght@400;700&family=Bebas+Neue&family=Jost:wght@300;600&family=Atkinson+Hyperlegible+Next:wght@400;700&family=Open+Sans:wght@300;800&display=swap" rel="stylesheet">
...
<div class="gracias-container">
    ...
    <p>En breve recibiras vía <strong>WhatsApp y Correo</strong> toda la información de tu pedido tal como guía de envío, # de pedido, etc...</p>
    </div>
    <div class="acciones">
        <a href="/catalogo.php" class="boton">Seguir comprando</a>
        <a href="https://wa.me/   573001112233   ?text=Hola%20acabo%20de%20realizar%20una%20compra%20y%20quiero%20confirmar%20mi%20pedido" target="_blank" class="boton">
