...
<div class="container text-center hero">
    <span class="msj-seccion">HOT</span>
</div> 
...
$sql = "SELECT producto_id, nombre, descripcion, precio, imagen, imagen_back, genero, tipo_producto, color FROM productos WHERE precio < 45000";
...
<section class="container-fluid d-flex justify-content-center mt-1">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            ?>
            <!-- Producto generado dinámicamente -->
            <div class="flip-card mb-4" data-producto_id="<?= htmlspecialchars($row['producto_id']); ?>">
                <div class="flip-card-inner">
                    <div class="flip-card-front" 
                        ...
                        <div class="info-produc"></div>
                            <div>
                                <button class="agregar mb-2" id="verMas">Ver más</button>
                            </div>
                    </div>
                    <div class="flip-card-back"><!-- Imagen trasera-->
